...
Fixpoint included (s1 : bag) (s2 : bag) : bool :=
  match s1 with
  | nil => true
  | h1 :: t1 => ((count h1 s1) <=? (count h1 s2)) && (included t1 s2)
  end.
...
Theorem add_inc_count : forall s:bag, forall n:nat,
...
Proof.
  intros l1 l2 l3. induction l4 as [| n4 l4' IHl4'].
    - simpl. rewrite -> app_nil_r. rewrite -> app_nil_r. rewrite -> app_assoc. reflexivity.
    - simpl. rewrite <- app_assoc. rewrite <- app_assoc. reflexivity.
Qed.

(** An exercise about your implementation of [nonzeros]: *)

Lemma nonzeros_add: forall (n : nat) (l: natlist), (nonzeros (n :: l)) = (nonzeros [n]) ++ (nonzeros l).
Proof. intros n l. destruct n as [| n'] eqn:E1.
    - simpl. reflexivity.
    - simpl. reflexivity.
Qed.
...
Proof.
  intros l1 l2. induction l1 as [| n1 l1' IHl1'].
    ...
    - rewrite -> nonzeros_add. replace ((n1 :: l1') ++ l2) with (n1 :: l1' ++ l2).
      + rewrite -> nonzeros_add. rewrite -> IHl1'. rewrite -> app_assoc. reflexivity.
      + simpl. reflexivity.
Qed. 
(** [] *)
...
Proof. intros v s1 s2.
  induction s1 as [|v1 s1' IHs1'].
    - simpl. reflexivity.
    - simpl. rewrite -> IHs1'. destruct (v1 =? v).
      + simpl. reflexivity. 
      + simpl. reflexivity.
Qed.
...
Proof.
  intros x. destruct x as [n] eqn:E.
